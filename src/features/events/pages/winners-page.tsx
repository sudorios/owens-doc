          ...
          <table className="w-full border-collapse">
            <thead className="bg-gray-700/50">
              <tr className="border-b border-gray-700">
                <th className="px-6 py-4 text-center text-gray-300 font-semibold text-sm">Posición</th>
                <th className="px-6 py-4 text-center text-gray-300 font-semibold text-sm">Usuario</th>
                <th className="px-6 py-4 text-center text-gray-300 font-semibold text-sm">Evento</th>
                <th className="px-6 py-4 text-center text-gray-300 font-semibold text-sm">Puntos</th>
              </tr>
            </thead>
            <tbody>
              {winners.map((winner: any, index) => (
                ...
                >
                  <td className="px-6 py-4">
                    <div className="flex items-center justify-center w-8 h-8 rounded-full bg-gray-800 text-gray-300 font-bold text-sm border border-gray-700 mx-auto">
                      {index + 1}
                    </div>
                  </td>
                  <td className="px-6 py-4 font-medium text-gray-200 text-center">
                    {winner.username || winner.user?.username || "Desconocido"}
                  </td>
                  <td className="px-6 py-4 text-blue-400 text-center">
                    {winner.eventName || "Evento"}
                  </td>
                  <td className="px-6 py-4 font-bold text-yellow-400 text-lg text-center">
